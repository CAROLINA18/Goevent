...
<html>
<head>
<title>GoEvent - Enterate de Eventos</title>
...
<header class="navbar navbar-default navbar-static-top" role="banner">
  <div class="container">
    <div class="navbar-header">
     ...
     <a class="navbar-brand" a href="./?view=user&id=<?php echo Session::$user->id; ?>"><i class="fa fa-smile-o"></i> GoEvent</a>
    </div>
...
<!-- Link Eventos-->
<li><a href="./?view=eventos">Eventos</a>
<li class="dropdown">
